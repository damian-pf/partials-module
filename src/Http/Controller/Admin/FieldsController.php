...
class FieldsController extends AdminController
{
     ...
     */
    public function index(FieldTableBuilder $table, PartialModel $partials)
    {
        $table->setStream($partials->getStream());
    ...
    {
        $form
            ->setStream($streams->findBySlugAndNamespace('partials', 'partials'))
